...
import 'feature/anamnese/anamnese_data_page.dart';
        ...
        GoRoute(
          ...
          routes: [
            ...
            GoRoute(
              ...
              routes: [
                GoRoute(
                  path: AppPage.anamneseData.path,
                  name: AppPage.anamneseData.name,
                  builder: (context, state) {
                    return AnamneseDataPage(
                      key: state.pageKey,
                    );
                  },
                ),
...
enum AppPage {
  ...
  anamneseData('anamneseData', 'anamneseData');
