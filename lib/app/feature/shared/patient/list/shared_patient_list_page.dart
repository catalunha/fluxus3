...
import 'shared_patient_obj.dart';

class SharedPatientListPage extends ConsumerWidget {
  const SharedPatientListPage({super.key});
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return SharedPatientObj(model: level);
                },
              ),
            ),
