...
import '../entity/hour_entity.dart';
...
class HourB4a {
  Future<List<HourModel>> list(
    ...
    try {
      ...
      List<HourModel> listTemp = <HourModel>[];
  ...
  Future<String> update(HourModel model) async {
    ...
    try {
      ...
      throw B4aException(
        errorTranslated,
        where: 'HourRepositoryB4a.update',
        originalError:
            '${parseResponse.error!.code} -${parseResponse.error!.message}',
      );
    }
  ...
  Future<bool> delete(String modelId) async {
    ...
    try {
      ...
      throw B4aException(
        errorTranslated,
        where: 'HourRepositoryB4a.delete',
        originalError:
            '${parseResponse.error!.code} -${parseResponse.error!.message}',
      );
    }
